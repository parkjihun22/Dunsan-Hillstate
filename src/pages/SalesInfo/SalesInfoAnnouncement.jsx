    ...
    <div className={styles.container}>
      <Helmet>
        ...
        <script type="application/ld+json">
          {`	{		"@context": "https://schema.org",		"@type": "WebPage",		"name": "힐스테이트 둔산 - 모집공고안내",		"description": "힐스테이트 둔산의 모집 공고는 분양 전 단계에서 중요한 안내문입니다. 이 페이지에서는 모집 공고에 포함된 중요한 날짜, 자격 조건, 필요한 서류 등을 명확하게 안내하여 예비 청약자들이 혼동 없이 청약을 준비할 수 있도록 지원합니다. 모집 공고를 통해 필수 정보들을 빠짐없이 체크하세요.",		"url": "https://www.ys-sujain.co.kr/SalesInfo/announcement"	}	`}
        </script>
      </Helmet>
