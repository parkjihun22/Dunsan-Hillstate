...
const FloorPlan2 = () => {
	...
	return (
		<div className={styles.container}>
            ...
            <h1 className={styles.screenReaderOnly}>힐스테이트 둔산 - 59B 평면안내 </h1>
			<p className={styles.screenReaderOnly}>59B타입의평면 안내 페이지는 힐스테이트 둔산의 각 아파트 평면도를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요.
			</p>
