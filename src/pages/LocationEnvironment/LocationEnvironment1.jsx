  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://www.a7lashare.com/LocationEnvironment/intro"
        />
        ...
        <script type="application/ld+json">
          {`	{		"@context": "https://schema.org",		"@type": "WebPage",		"name": "힐스테이트 둔산 - 입지안내",		"description": "힐스테이트 둔산의 입지 정보를 확인하세요. 뛰어난 교통망, 생활 인프라, 교육 및 쇼핑 시설 등 편리한 주변 환경을 소개하며, 평택의 중심에서 누릴 수 있는 생활의 편리함과 가치를 제공합니다",		"url": "https://www.a7lashare.com/LocationEnvironment/intro"	}	`}
        </script>
      </Helmet>
