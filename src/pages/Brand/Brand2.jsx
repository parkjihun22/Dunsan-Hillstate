  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <meta
          name="description"
          content="힐스테이트 둔산의 홍보영상을 통해 단지의 매력적인 디자인과 최신 편의시설을 생생하게 만나보세요. 현대적 감각과 고급스러움을 결합한 주거 환경, 평택의 중심에서 경험할 수 있는 새로운 라이프스타일을 영상으로 확인하세요."
        />
        <meta
          name="keywords"
          ...
          {`
															{
																...
																"@type": "WebPage",
																"name": "힐스테이트 둔산 - 홍보영상",
																"description": "힐스테이트 둔산의 홍보영상을 통해 단지의 매력적인 디자인과 최신 편의시설을 생생하게 만나보세요. 현대적 감각과 고급스러움을 결합한 주거 환경, 평택의 중심에서 경험할 수 있는 새로운 라이프스타일을 영상으로 확인하세요.
					",
      ...
      <p className={styles.screenReaderOnly}>
        힐스테이트 둔산의 홍보영상을 통해 단지의 매력적인 디자인과 최신
