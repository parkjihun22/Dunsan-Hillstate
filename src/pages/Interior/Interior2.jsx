  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://www.ys-sujain.co.kr/Interior/84A"
        />
        ...
        <script type="application/ld+json">
          {`	{		"@context": "https://schema.org",		"@type": "WebPage",		"name": "힐스테이트 둔산 - 84A 인테리어",		"description": "84A타입의 인테리어 페이지에서는 힐스테이트 둔산의 고급 인테리어 디자인을 소개합니다. 세련된 디자인과 최첨단 인테리어 요소들이 결합되어, 입주자들에게 고급스러움과 편안함을 제공합니다. 각 공간의 인테리어 스타일과 자재를 확인하여 더욱 매력적인 주거 공간을 발견할 수 있습니다.",		"url": "https://www.ys-sujain.co.kr/Interior/84A"	}	`}
        </script>
      </Helmet>
