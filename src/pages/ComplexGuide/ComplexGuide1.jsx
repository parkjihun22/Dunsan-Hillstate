  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>힐스테이트 둔산 - 단지배치도</title>
        <meta
          name="description"
          content="힐스테이트 둔산의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다.
								"
        />
        <meta
          name="keywords"
          ...
          {`
																		{
																			...
																			"@type": "WebPage",
																			"name": "힐스테이트 둔산 - 단지배치도",
																			"description": "힐스테이트 둔산의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다.",
      ...
      <p className={styles.screenReaderOnly}>
        단지 배치도 페이지는 힐스테이트 둔산의 전체 단지 구성도를
