...
<Helmet>
		...
		{/* SEO 최적화를 위한 메타 태그 */}
		<title>힐스테이트둔산 - 단지배치도</title>
		<meta
		  name="description"
		  content="힐스테이트둔산의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다.
"
		/>
  		<meta name="keywords" content="둔산힐스테이트, 힐스테이트둔산, 임대" />	
		<link
		  rel="canonical"
		  href="https://www.dwbsongs.com/ComplexGuide/intro"
		/>

		{/* Open Graph - 소셜 미디어 공유 최적화 */}
		<meta
		  property="og:title"
		  content="힐스테이트둔산 - 단지배치도"
		/>
		<meta
...
"
		...
		<meta
		  property="og:url"
		  content="https://www.dwbsongs.com/ComplexGuide/intro"
		/>
		  ...
		  {`
										{
											...
											"@type": "WebPage",
											"name": "힐스테이트둔산 - 단지배치도",
											"description": "힐스테이트둔산의 단지 배치도를 통해 각 동의 위치와 편의시설의 배치를 확인하세요. 효율적인 동선 설계와 조경 공간, 입주민의 생활 편의를 고려한 배치를 상세히 안내합니다.
",
            ...
            <h1 className={styles.screenReaderOnly}>힐스테이트둔산 - 단지배치도</h1>
			<p className={styles.screenReaderOnly}>단지 배치도 페이지는 힐스테이트둔산의 전체 단지 구성도를 제공합니다. 아파트 단지 내 세대 배치, 공용 시설, 주차 공간 등을 시각적으로 보여주어 입주자들이 공간 배치에 대해 명확하게 이해할 수 있도록 돕습니다. 이 배치도를 통해 단지 내 생활을 더 쉽게 계획할 수 있습니다.
			</p>
