...
<Helmet>
		...
		{/* SEO 최적화를 위한 메타 태그 */}
		<title>힐스테이트둔산 - 당첨자 서류안내</title>
		<meta
		  name="description"
		  content="힐스테이트둔산 선착순계약을 위한 필수 서류 목록과 준비 절차를 안내합니다. 간단하고 명확한 정보로 청약 당첨 후 필요한 준비를 돕고, 서류 제출에 문제가 없도록 상세한 가이드를 제공합니다
"
		/>
...
"
		...
		<meta
		  property="og:url"
		  content="https://www.dwbsongs.com/BusinessGuide/documents"
		/>
		  ...
		  {`
										{
											...
											"@type": "WebPage",
											"name": "힐스테이트둔산 - 당첨자 서류안내",
											"description": "힐스테이트둔산 선착순계약을 위한 필수 서류 목록과 준비 절차를 안내합니다. 간단하고 명확한 정보로 청약 당첨 후 필요한 준비를 돕고, 서류 제출에 문제가 없도록 상세한 가이드를 제공합니다
",
											"url": "https://www.dwbsongs.com/BusinessGuide/documents"
										}
										`}
		</script>
	  </Helmet>  
            ...
            <h1 className={styles.screenReaderOnly}>힐스테이트둔산  - 계약서류안내</h1>
			...
			<img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="힐스테이트둔산 계약서류안내-image1" />
