  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>힐스테이트 둔산 - 당첨자 서류안내</title>
        <meta
          name="description"
          content="힐스테이트 둔산 청약 당첨자를 위한 필수 서류 목록과 준비 절차를 안내합니다. 간단하고 명확한 정보로 청약 당첨 후 필요한 준비를 돕고, 서류 제출에 문제가 없도록 상세한 가이드를 제공합니다
			"
        />
        <meta
          name="keywords"
          ...
          {`
													{
														...
														"@type": "WebPage",
														"name": "힐스테이트 둔산 - 당첨자 서류안내",
														"description": "힐스테이트 둔산 청약 당첨자를 위한 필수 서류 목록과 준비 절차를 안내합니다. 간단하고 명확한 정보로 청약 당첨 후 필요한 준비를 돕고, 서류 제출에 문제가 없도록 상세한 가이드를 제공합니다",
      ...
      <div className={styles.textBox}>
        ...
        <div>힐스테이트 둔산의 새로운 자부심으로 찾아옵니다.</div>
			...
			<img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="힐스테이트 둔산 계약서류안내-image1" />
