...
const BusinessGuide1 = () => {
	...
	return (
		<div className={styles.container}>
				...
				<meta 
					name="description" 
					content="힐스테이트둔산의 사업개요를 통해 프로젝트의 비전과 가치를 확인하세요. 단지 설계, 개발 목표, 주변 환경과의 조화 등을 설명하며 평택의 새로운 주거 중심지 가능성을 보여드립니다." 
				/>
				...
				<script type="application/ld+json">
					{`
					{
						...
						"@type": "WebPage",
						"name": "힐스테이트둔산 - 사업안내",
						"description": "힐스테이트둔산의 사업개요를 통해 프로젝트의 비전과 가치를 확인하세요. 단지 설계, 개발 목표, 주변 환경과의 조화 등을 설명하며 평택의 새로운 주거 중심지 가능성을 보여드립니다.",
